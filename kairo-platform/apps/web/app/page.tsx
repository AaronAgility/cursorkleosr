...
import { Rocket, BookOpen, Settings, Bot, Zap } from 'lucide-react';
...
export default function HomePage() {
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex flex-col">
      {/* Header */}
      <header className="bg-gradient-to-r from-gray-800 to-gray-700 border-b border-gray-600 px-4 py-2">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-shrink-0">
                <svg width="112" height="82" viewBox="0 0 141 36" fill="none" xmlns="http://www.w3.org/2000/svg" className="scale-110 -mt-1">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-2 px-3 py-2 bg-gray-700/50 rounded-lg">
              ...
              <span className="text-sm text-gray-300">{projectSettings.enabledAgents.length} agents active</span>
            </div>
          </div>
        </div>
      </header>
